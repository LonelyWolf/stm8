...
void UART_Init(void) {
    PA_DDR_bit.DDR2 = 1; // Set TX pin (PA2) as output
    PA_CR1_bit.C12  = 1; // Configure PA2 as push-pull
    PA_CR2_bit.C22  = 1; // 10MHz output
    PA_ODR_bit.ODR2 = 1; // Set 1 for output (remove trash in first byte transfered)
    ...
    //USART1_BRR2 = 0x04; // 38400bps at 2MHz CPU clock
    //USART1_BRR1 = 0x03;
    //USART1_BRR2 = 0x02; // 57600bps at 2MHz CPU clock
    //USART1_BRR1 = 0x02;
    USART1_BRR2 = 0x02; // 115200bps at 2MHz CPU clock
    USART1_BRR1 = 0x01;
